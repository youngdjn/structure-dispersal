...
trees = read_excel("data/overstory/emerald_point/EPT_tree_data.xlsx",sheet=1)
plots = read_excel("data/overstory/emerald_point/EPT_tree_data.xlsx",sheet=2)
...
st_write(trees_sp %>% st_transform(4326),"data/overstory/emerald_point/ept_trees.gpkg",delete_dsn=TRUE)
