...
point = st_read("/home/derek/Documents/data/str-disp_data/regen/plot_layout/lassic/stem_map_centers.gpkg")
...
st_write(allcenters,"/home/derek/Documents/data/str-disp_data/regen/plot_layout/forfield/lassic/lassic_stemmap_centers.kml",delete_dsn = TRUE)
st_write(allcorners,"/home/derek/Documents/data/str-disp_data/regen/plot_layout/forfield/lassic/lassic_stemmap_corners.kml",delete_dsn = TRUE)

st_write(allpoints,"/home/derek/Documents/data/str-disp_data/regen/plot_layout/forfield/lassic/lassic_stemmap_grid.geojson",delete_dsn = TRUE)
